        ...
        <section className="bg-white p-8 rounded-[2.5rem] shadow-sm space-y-6">
           ...
           <div className="space-y-4">
              <div>
                 ...
                 <input type="text" placeholder="Enter theatre name" className="w-full bg-gray-50 border-none rounded-xl p-4 text-sm focus:ring-2 focus:ring-[#FF8C00]/20 outline-none" />
              </div>
              <div>
                 <label className="block text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2 ml-1">Address</label>
                 <textarea placeholder="Full address of the theatre..." className="w-full bg-gray-50 border-none rounded-xl p-4 text-sm focus:ring-2 focus:ring-[#FF8C00]/20 outline-none h-24" />
              </div>
           </div>
        </section>
           ...
           <div className="grid grid-cols-1 gap-4">
              {['Accessibility Accommodations', 'Refreshments Available', 'Types of Screen Available'].map(item => (
                <div key={item} className="p-5 bg-white/5 border border-white/10 rounded-2xl flex justify-between items-center group cursor-pointer hover:bg-white/10">
                   ...
                   <button className="text-[#FF8C00] font-black text-[10px] uppercase tracking-widest">+ Add New</button>
                </div>
              ))}
           </div>
        </section>

        <button className="w-full bg-[#FF8C00] text-white py-5 rounded-3xl font-black uppercase tracking-[0.2em] shadow-2xl active:scale-[0.98] transition-all">
